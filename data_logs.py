...
def process_media(url, is_movie, log_filename, existing_ids):
    ...
    for page in range(1, total_pages + 1):
        ...
        write_to_log(log_filename, page_data, is_movie, existing_ids)
...
# Output
output_filename = 'media_list.log'

# Get IDs from the log file
existing_ids = get_existing_ids(output_filename)
